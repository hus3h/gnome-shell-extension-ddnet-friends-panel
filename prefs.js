...
function addFilePicker({ group, key, settings, prefs }) {
...
function buildPrefsWidget() {
    ...
    const configPathPicker = addFilePicker({
        settings: settings,
        prefs: prefs,
    ...
    defaultButton.connect('clicked', () => {
        ...
        configPathPicker.label.label = DEFAULT_FILE_LABEL;
    });
